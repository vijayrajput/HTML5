sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/sdc/hcp/bootcamp/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#JobOpenings-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#JobOpenings-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.sap.sdc.hcp.bootcamp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/sdc/hcp/bootcamp/localService/mockserver"], function (mockserver) {
